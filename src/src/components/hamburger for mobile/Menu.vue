				...
				<nav class="hamburger-nav">
					...
					>
						<div class="hamburger-nav-contain gender">
							...
							>{{ item }}
								<span class="checked-contain"
									v-if="genderActive.indexOf( item ) !== -1"
								>
									<img src="https://img.icons8.com/ios/13/000000/checkmark.png" alt="+">
								</span>
							</button>
						</div>
						<div class="line"></div>
					...
					<div class="hamburger-nav-contain-brends">
						...
						>{{ item }}
							<span class="checked-contain"
								v-if="brandsActive.indexOf( item ) !== -1"
							>
								<img src="https://img.icons8.com/ios/13/000000/checkmark.png" alt="+">
							</span>
						</button>
...
export default {
	...
	methods: {
		...
		checkTouchEnd( e ){
			// console.log( e.changedTouches[0].clientX - this.clientX <= 100 );
			// this.clientX -= 150;
